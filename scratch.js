...
function renderCards() {
  cards.forEach((card, index) => {
    ...
    cardElement.addEventListener('mousedown', handleCardClick);

    const cardImageBottom = document.createElement('img');
    cardImageBottom.classList.add('bottom');

    const cardImageTop = document.createElement('canvas'),
      canvasWidth = cardImageTop.width,
      canvasHeight = cardImageTop.height,
    ...
    image.onload = function () {
      ...
      cardElement.querySelector('.bottom').style.visibility = 'visible';
    };
